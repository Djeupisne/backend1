...
# Configuration CORS : remplace par l'URL de ton frontend si nécessaire
...
# --- CONNEXION REDIS CORRIGÉE ---
# On récupère les variables depuis Render, sinon on utilise les valeurs par défaut
redis_client = redis.Redis(
    host=os.getenv("REDIS_HOST", "redis-11133.c8.us-east-1-4.ec2.cloud.redislabs.com"),
    port=int(os.getenv("REDIS_PORT", 11133)),
    username="default",  # L'utilisateur vu sur ta capture d'écran
    password=os.getenv("REDIS_PASSWORD", "WKJdeilasGOWkXJWOHwqcRV7X5uWwQ"), # Ton mot de passe de base de données
...
def init_recruteur():
    try:
        # Test de connexion et initialisation du compte admin
        ...
        print(f"⚠️ Erreur de connexion Redis : {e}")
...
def login():
    ...
    # Recherche du recruteur dans Redis
...
if __name__ == '__main__':
    # Le port 10000 est crucial pour Render
