...
"Chef de Section Compensation": {
"eliminatoire": [
"Expérience dans une banque ou établissement financier réglementé",
...
"Connaissance des règles BEAC / GIMAC ou système de compensation équivalent",
"Expérience de gestion de suspens, rejets ou réclamations interbancaires",
"Expérience d'encadrement ou supervision d'équipe (niveau chef de section)"
],
"a_verifier": [
"Supervision quotidienne des opérations de compensation interbancaire",
"Dénouement de positions nettes en fin de journée",
"Gestion des suspens, rejets et réclamations interbancaires",
"Encadrement et coordination d'une équipe opérationnelle",
"Utilisation de systèmes de compensation (SYSTAC, SYGMA, SWIFT ou équivalent)",
"Production de reportings opérationnels ou réglementaires (BEAC, hiérarchie)",
"Participation à des audits COBAC ou contrôles internes"
],
"signaux_forts": [
"BEAC / GIMAC / compensation interbancaire (SYSTAC, SYGMA)",
"Règlement de positions nettes / dénouement dans les délais réglementaires",
"Contrôle de conformité réglementaire et procédurale des opérations",
"Maîtrise du contrôle interne et comptabilité bancaire (SYSCOHADA)",
"Gestion de fin de journée comptable / clôture des opérations interbancaires",
"Rapports opérationnels ou réglementaires produits (fréquence, destinataires)",
"Expérience dans une banque de la zone CEMAC / UEMOA",
"Audits COBAC ou contrôles internes réussis sans réserve majeure",
"Gestion d'une équipe avec résultats mesurables (effectif, délais, incidents réduits)"
],
"points_attention": [
...
"Absence totale de rôle managérial (incompatible chef de section)",
...
"Maîtrise des outils non mentionnée (ni SWIFT, ni outil de compensation, ni ERP)",
...
typo_corrections = {
'risque de marche': 'risque de marché', 'risque marche': 'risque marché',
'market risk': 'market risk', 'taux de change': 'taux de change',
'liquidite': 'liquidité', 'competence': 'compétence', 'experience': 'expérience'
}
...
technical_keywords = [
'var', 'value at risk', 'stress testing', 'trading', 'alm', 'bâle', 'ficc',
'positions', 'modélisation', 'quantitatif', 'quantitative', 'modeling',
'risque de marché', 'market risk', 'taux', 'change', 'liquidité', 'fx',
'risque de marche', 'risque marche', 'reporting', 'trésorerie',
'gestion des risques', 'risque opérationnel', 'responsable risque', 'directeur risque'
]
...
'ecobank', 'orabank', 'uba', 'mtn', 'airtel', 'salam', 'financial services',
'telecommunications', 'critical systems'
]), re.IGNORECASE)
...
r'jan|fev|mar|avr|juil|aou|sep|oct|nov|dec)\s*)?'
r'(20\d{2}|19\d{2})'
r'\s*(?:a|-|–|—|au|jusqu\'au|to|until|au\s+)?\s*'
...
r'\(\s*(\d+)\s*\)\s*(?:années?|ans?)',
r'\w+\s+\(\s*(\d+)\s*\)\s*(?:années?|ans?)',
...
"Expérience dans une banque ou établissement financier réglementé": ["banque", "bancaire", "etablissement bancaire", "institution bancaire", "banque commerciale", "etablissement financier reglemente", "bank", "commercial bank", "financial institution", "ecobank", "orabank", "uba", "bicec", "sgbc", "societe generale", "standard chartered", "nsia banque"],
"Minimum 5 ans en opérations bancaires ou back-office (hors stage)": ["EXP_COMP_5ANS"],
"Exposition aux opérations de compensation interbancaire (chèques, virements, prélèvements)": ["compensation interbancaire", "compensation bancaire", "interbank clearing", "cheques", "cheque", "checks", "virements", "transferts", "wire transfer", "prelevements", "direct debit", "sepa", "operations de compensation", "chambre de compensation", "clearing house", "settlement", "reglement", "compensation des effets", "clearing operations", "payment systems", "systemes de paiement", "flux interbancaires", "interbank flows"],
"Connaissance des règles BEAC / GIMAC ou système de compensation équivalent": ["beac", "gimac", "regles beac", "reglementation beac", "circulaire beac", "groupe interbancaire monetique", "systeme de compensation", "systeme de paiement", "payment system", "clearing system", "spectra", "cerber", "swift", "mt103", "mt202", "iso 20022", "regles de compensation", "clearing rules", "settlement rules"],
"Expérience de gestion de suspens, rejets ou réclamations interbancaires": ["suspens", "suspense", "rejets", "rejects", "reclamations", "claims", "litiges", "disputes", "resolution incidents", "gestion des impayes", "regularisation", "reconciliation", "rapprochement", "anomalies", "incidents de paiement", "suspens interbancaires", "rejets de cheques", "retours effets"],
"Expérience d'encadrement ou supervision d'équipe (niveau chef de section)": ["chef de section", "chef de service", "responsable", "manager", "encadrement", "supervision", "management d'equipe", "team leader", "direction", "head of", "responsable d'equipe", "superviseur", "management operationnel", "team management", "encadrement equipe"],
"Supervision quotidienne des opérations de compensation interbancaire": ["supervision compensation", "pilotage compensation", "suivi compensation", "monitoring compensation", "daily clearing", "suivi quotidien", "supervision operations", "operations monitoring", "suivi des operations"],
"Dénouement de positions nettes en fin de journée": ["positions nettes", "net positions", "denouement", "settlement", "fin de journee", "end of day", "eod", "cloture journaliere", "positions nettes journalieres", "daily settlement", "reglement net"],
"Gestion des suspens, rejets et réclamations interbancaires": ["gestion suspens", "suspense management", "gestion rejets", "rejets interbancaires", "reclamations interbancaires", "traitement litiges", "dispute resolution", "regularisation"],
"Encadrement et coordination d'une équipe opérationnelle": ["encadrement equipe", "coordination equipe", "management equipe", "team coordination", "supervision operationnelle", "pilotage equipe", "animation equipe", "management de proximite"],
"Utilisation de systèmes de compensation (SYSTAC, SYGMA, SWIFT ou équivalent)": ["systac", "sygma", "swift", "alliance lite2", "interact", "core banking", "systeme bancaire", "application bancaire", "erp bancaire", "systeme de compensation", "clearing system", "temenos", "flexcube", "amplitude", "spectrum"],
"Production de reportings opérationnels ou réglementaires (BEAC, hiérarchie)": ["reporting operationnel", "reporting reglementaire", "rapport beac", "declaration beac", "reporting hiérarchie", "tableau de bord", "kpi operationnels", "reporting quotidien", "reporting hebdomadaire", "reporting mensuel", "regulatory reporting", "operational reporting"],
"Participation à des audits COBAC ou contrôles internes": ["audit cobac", "controle interne", "inspection bancaire", "audit interne", "internal audit", "mission d'audit", "conformite reglementaire", "regulatory compliance", "cobac"],
"BEAC / GIMAC / compensation interbancaire (SYSTAC, SYGMA)": ["beac", "gimac", "compensation interbancaire", "systac", "sygma", "bank of central african states", "groupe interbancaire monetique"],
"Règlement de positions nettes / dénouement dans les délais réglementaires": ["positions nettes", "delais reglementaires", "reglement dans les delais", "settlement deadlines", "regulatory deadlines", "delais beac", "conformite delais", "timely settlement"],
"Contrôle de conformité réglementaire et procédurale des opérations": ["controle conformite", "conformite reglementaire", "conformite procedurale", "regulatory compliance", "procedural compliance", "controle des operations", "verification conformite", "compliance monitoring"],
"Maîtrise du contrôle interne et comptabilité bancaire (SYSCOHADA)": ["controle interne", "internal control", "comptabilite bancaire", "banking accounting", "syscohada", "plan comptable bancaire", "normes comptables bancaires", "ecritures comptables"],
"Gestion de fin de journée comptable / clôture des opérations interbancaires": ["fin de journee comptable", "cloture journaliere", "end of day", "eod processing", "cloture operations", "daily closing", "arretes journaliers", "cloture interbancaire"],
"Rapports opérationnels ou réglementaires produits (fréquence, destinataires)": ["rapports operationnels", "rapports reglementaires", "reporting", "production rapports", "rapports beac", "rapports cobac", "rapports direction", "rapports hiérarchie"],
"Expérience dans une banque de la zone CEMAC / UEMOA": ["cemac", "uemoa", "zone cemac", "zone uemoa", "afrique centrale", "afrique de l'ouest", "central africa", "west africa", "cameroun", "tchad", "congo", "gabon", "guinee equatoriale", "centrafrique", "senegal", "cote d'ivoire", "mali", "benin"],
"Audits COBAC ou contrôles internes réussis sans réserve majeure": ["audit cobac", "controle interne", "sans reserve", "clean audit", "audit reussi", "inspection reussie", "audit sans observation", "rapport d'audit favorable"],
"Gestion d'une équipe avec résultats mesurables (effectif, délais, incidents réduits)": ["equipe", "effectif", "collaborateurs", "team size", "headcount", "resultats mesurables", "kpi", "indicateurs", "incidents reduits", "amelioration delais", "performance equipe", "productivite"],
"Parcours purement comptable sans exposition aux opérations interbancaires": ["comptable", "comptabilite", "accounting", "comptable unique", "comptable general", "sans exposition interbancaire"],
"Rôle uniquement administratif ou de support sans responsabilité opérationnelle": ["administratif", "support", "assistant", "assistant administratif", "secrétariat", "back office support"],
"Absence totale de rôle managérial (incompatible chef de section)": ["sans encadrement", "sans management", "pas de management", "no management", "no supervision"],
"CV aux missions trop génériques sans livrables ni résultats quantifiés": ["missions generiques", "taches variees", "sans resultats", "generic tasks", "no results"],
"Expériences très courtes (< 1 an par poste) sans progression visible": ["experiences courtes", "short experiences", "moins d'un an", "less than one year", "sans progression"],
"Maîtrise des outils non mentionnée (ni SWIFT, ni outil de compensation, ni ERP)": ["outils non mentionnes", "no tools", "no systems", "sans maitrise outil"],
"Trous inexpliqués dans le parcours professionnel": ["trou parcours", "gap", "periode inexpliquee", "unexplained gap", "interruption carriere"]
}
DOMAIN_KEYWORDS_MAP = {
...
"EXP_COMP_5ANS": ["compensation", "compensation interbancaire", "clearing", "settlement", "banque", "bancaire", "back office", "back-office", "operations", "interbancaire", "cheques", "virements", "beac", "gimac", "suspens", "rejets", "positions nettes"]
}
EXP_MIN_YEARS_MAP = {
"EXP_CREDIT_3ANS": 3.0,
"EXP_FIN_3ANS": 3.0,
...
'score': score_total,
'decision': decision,
'bloc_cv': {'total': score_cv_total, 'max': 70, 'details': score_cv, 'raw_total': total_cv_raw, 'raw_max': max_cv_raw},
'bloc_lm': {'total': score_lm_total, 'max': 20, 'details': score_lm},
'bloc_diplomes': {'total': score_diplomes_total, 'max': 10, 'details': score_diplomes},
'details': details,
...
exp_elim_count = sum(1 for k, v in checklist.items() if k.startswith('elim_') and v and any(x in grille['eliminatoire'][int(k.split('_')[1])].lower() for x in ['expérience', 'ans', 'exposition', 'connaissance']))
adequation = min(3, exp_elim_count)
beac_gimac_signals = ["BEAC / GIMAC / compensation interbancaire (SYSTAC, SYGMA)", "Règlement de positions nettes / dénouement dans les délais réglementaires", "Expérience dans une banque de la zone CEMAC / UEMOA"]
beac_count = sum(1 for s in beac_gimac_signals if s in signaux)
exposition_beac = min(3, beac_count)
mgmt_signals = ["Gestion d'une équipe avec résultats mesurables (effectif, délais, incidents réduits)", "Encadrement et coordination d'une équipe opérationnelle"]
mgmt_count = sum(1 for s in mgmt_signals if s in signaux)
encadrement = min(2, mgmt_count)
progression_score = 0
if len(signaux) >= 3:
progression_score += 1
has_short_exp = any("courtes" in a.lower() or "trous" in a.lower() for a in details.get('alertes_attention', []))
if not has_short_exp and len(signaux) >= 2:
progression_score += 1
coherence = min(2, progression_score)
qualite_cv = 0
cv_lower = cv_text.lower()
quantified_markers = re.findall(r'\d+\s*(?:%|personnes|collaborateurs|incidents|jours|mois)', cv_lower)
if len(quantified_markers) >= 3:
qualite_cv = 1
lettre_motiv = 0
if lettre_text and len(lettre_text.strip()) > 100:
lettre_lower = lettre_text.lower()
if any(kw in lettre_lower for kw in ['beac', 'gimac', 'compensation', 'cemac', 'uemoa']):
lettre_motiv = 1
elif any(kw in lettre_lower for kw in ['banque', 'bancaire', 'interbancaire']):
lettre_motiv = 1
score_final = adequation + exposition_beac + encadrement + coherence + qualite_cv + lettre_motiv
score_final = min(12, score_final)
if score_final >= 10:
...
'scoring_type': '12_points',
'adequation_experience': adequation,
'exposition_beac_gimac': exposition_beac,
'capacite_encadrement': encadrement,
'coherence_progression': coherence,
'qualite_cv': qualite_cv,
'lettre_motivation': lettre_motiv,
'score_final': score_final,
'decision': decision,
'note': f"Score: {score_final}/12 — {decision}",
'documents_analyses': details['documents_analyses']
}
}
...
tag = "⚠️ ÉLIMINÉ" if result['score_breakdown'].get('bloc1_eliminatoire') else "✅"
print(f"{tag} Score {token}: {result['score']}/12 — {result['score_breakdown'].get('note','')}")
else:
tag = "⚠️ ÉLIMINÉ" if result['score_breakdown'].get('bloc1_eliminatoire') else "✅"
...
expo = sb.get('exposition_beac_gimac', 0) if not elim else 0
enc = sb.get('capacite_encadrement', 0) if not elim else 0
coh = sb.get('coherence_progression', 0) if not elim else 0
...
str(sb.get('coherence_parcours', sb.get('coherence_progression', 0))),
str(sb.get('exposition_risque_metier', sb.get('exposition_beac_gimac', 0))),
str(sb.get('note', '') or ''),
str(reco)
])
out.seek(0)
...
return jsonify({'sent': ok, 'smtp_user': smtp_user, 'smtp_from': smtp_from, 'password_length': len(smtp_password)}), 200
except Exception as e:
import traceback
...
print(f"🆕 Chef de Section Compensation: Scoring /12 avec BEAC/GIMAC/CEMAC")
