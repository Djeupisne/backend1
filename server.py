...
jwt = JWTManager(app)
redis_client = redis.Redis(host="redis-11133.c8.us-east-1-4.ec2.cloud.redislabs.com", port=11133, password=os.getenv("REDIS_PASSWORD", "63365a00edce4c2295425a36ec476d50"), decode_responses=True)
...
def init_recruteur():
    ...
    except Exception as e: print(f"⚠️ Erreur Redis: {e}")
init_recruteur()
