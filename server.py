...
def health_check():
    return jsonify({
        ...
        'version': 'v9.7-ia-scores-gardes-indentation-corrigee',
        'features': {
...
9. Utilise le format JSON attendu avec les sous-scores."""
    try:
        ...
        result = {
            'score': score_total,  # ✅ Score calculé à partir des sous-scores
            'score_max': score_max,
            'decision': decision,
            'flags_eliminatoires': flags_elim,
...
if __name__ == '__main__':
    ...
    logger.info("=" * 60)
    logger.info(f"🚀 RecrutBank API v9.7 - IA Scores Gardes - Indentation Corrigee")
    logger.info("=" * 60)
